        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="relative p-10 border border-neon-magenta/30 clip-chamfer bg-cyber-card/20">
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <Link
                href="/submit"
                className="inline-flex items-center gap-2 px-6 py-2.5 border border-neon-cyan clip-chamfer text-neon-cyan font-orbitron text-sm uppercase tracking-wider hover:bg-neon-cyan/10 transition-colors"
              >
